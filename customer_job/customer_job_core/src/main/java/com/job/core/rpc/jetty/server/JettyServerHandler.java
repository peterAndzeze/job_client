...
/**
 * 
 * @Title: JettyServerHandler.java
 * @Package: com.job.core.rpc.jetty.server
 * @Description: jetty服务处理
 * @author: sunwei
 * @date: 2017年5月15日 上午11:16:55
 * @version: V1.0
 */
public class JettyServerHandler extends AbstractHandler {
	...
	private RpcResponse doInvoke(HttpServletRequest request) {
		try {
			...
			RpcRequest rpcRequest = (RpcRequest) new HessianSerializer().deserialize(requestBytes, RpcRequest.class);

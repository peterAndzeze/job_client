...
/*============================================= 主界面   =============================================*/
	...
	var ds = new Ext.data.JsonStore({
		...
		id: 'id',
		fields:['id', 'display','key', 'value', 'value1', 'state','createTime']
	});
	/* var buttons = [
	      			{xtype:'tbseparator'},
		...
		//phenix.grid.createIconCol(),
		{
		  ...
		  dataIndex:'key'
			...
			renderer:function(value){
				return phenix.data.transform(value,systemDateState);
			}
		  },{
		  	header:'创建时间',
		    dataIndex:'createTime',
		    renderer: phenix.util.formatDateTime
		  }
	]);
/*============================== 主界面 ==========================================*/
	//子字典列表
